...
본격 마크다운 에디터, 3D 신경망 그래프, AI 검색, 간격 반복(spaced repetition)을 모두 갖춘 **자기 컴파일(self-compiling) 지식 베이스**입니다. **데스크톱 앱**, **CLI**, **Obsidian 플러그인**, **MCP 서버** 형태로 제공되며, 볼트(vault) 파일은 절대 수정되지 않습니다.
