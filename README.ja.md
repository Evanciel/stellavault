...
[**⬇ デスクトップアプリをダウンロード**](https://github.com/Evanciel/stellavault/releases/tag/desktop-v0.1.1) · [**⚡ クイックスタート**](#インストール) · [**🤖 MCP セットアップ**](#mcp-連携-21ツール) · [**🌐 ライブデモ**](https://evanciel.github.io/stellavault/)
...
<table>
  <tr>
    <td align="center"><a href="https://github.com/Evanciel/stellavault/releases/download/desktop-v0.1.1/Stellavault-win32-x64-0.1.1.zip"><br/><b>⬇ Windows 版をダウンロード</b><br/><sub>x64 · 273 MB · ZIP</sub></a></td>
    <td align="center"><a href="https://github.com/Evanciel/stellavault/releases/download/desktop-v0.1.1/Stellavault-linux-x64-0.1.1.zip"><br/><b>⬇ Linux 版をダウンロード</b><br/><sub>x64 · 243 MB · ZIP</sub></a></td>
...
- **[⬇ デスクトップアプリをダウンロード](https://github.com/Evanciel/stellavault/releases/tag/desktop-v0.1.1)**
