...
const strings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'btn.heatmap': 'Heatmap',
    'btn.gaps': 'Gaps',
    // Edge class filter — wiki links vs AI cosine similarity
    'btn.edges': 'Edges',
    'btn.edges.both': 'All',
    'btn.edges.links': 'Links',
    'btn.edges.semantic': 'Semantic',
    'btn.edges.hint': 'Show wiki links, AI similarity, or both',
    'btn.edges.linkCount': 'wiki links in this view',
    'btn.export': 'Export',
    ...
    // Cold-build phases surfaced by /api/graph/status. Keys mirror GraphBuildProgress.phase
    // exactly; an unknown phase falls through to the key itself, which is still readable.
    'status.loading': 'Loading...',
    'status.phase.loading': 'Reading vault index...',
    'status.phase.edges': 'Connecting notes',
    'status.phase.clustering': 'Finding clusters',
    'status.phase.assembling': 'Assembling graph',
    'status.phase.done': 'Done',
    'node.localGraph': '◎ Local graph (neighbours only)',
    'scene.back': '← Back',
    'scene.all': 'All',
    'scene.hops': 'hops',
    'scene.tags': '#tags',
    'scene.tagsEmpty': 'No tag is shared by 2+ notes in this vault',
    // Onboarding
  ...
  ko: {
    ...
    'btn.edges': '연결',
    'btn.edges.both': '전체',
    'btn.edges.links': '직접 링크',
    'btn.edges.semantic': 'AI 유사도',
    'btn.edges.hint': '직접 링크(위키링크)만, AI 유사도만, 또는 둘 다 보기',
    'btn.edges.linkCount': '개의 직접 링크',
    'btn.export': '내보내기',
    ...
    'status.phase.loading': '볼트 색인 읽는 중...',
    'status.phase.edges': '노트 연결 중',
    'status.phase.clustering': '군집 찾는 중',
    'status.phase.assembling': '그래프 조립 중',
    'status.phase.done': '완료',
    'node.localGraph': '◎ 이 노트 주변만 보기',
    'scene.back': '← 뒤로',
    'scene.all': '전체',
    'scene.hops': '홈',
    'scene.tags': '#태그',
    'scene.tagsEmpty': '이 볼트에는 2개 이상 노트가 공유하는 태그가 없습니다',
