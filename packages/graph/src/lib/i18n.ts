...
const strings: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'btn.clusterView': 'Cluster',
    'btn.allNodes': 'All nodes',
    'btn.allClusters': 'All clusters',
    'btn.stars': 'Stars',
    ...
    'ingest.recent': 'Recent Saves',
    'ingest.goto': '→ Go to node',
    'ingest.notIndexed': 'Not indexed yet. Click "Reindex" below.',
    'ingest.reindexing': 'Reindexing...',
    'ingest.reindexDone': 'Reindex complete!',
    'ingest.reindexFail': 'Reindex failed',
    'ingest.reindexBtn': 'Reindex new notes (update graph)',
    'ingest.reindexBtnActive': 'Reindexing...',
    // Intelligence
    'intel.ask': 'Ask',
    ...
    // Node detail
    'node.edit': 'Edit',
    'node.editCancel': 'Cancel Edit',
    'node.delete': 'Delete',
    'node.deleteConfirm': 'Delete this note? It will also be removed from your Obsidian vault.',
    'node.save': 'Save (syncs to Obsidian)',
    'node.saving': 'Saving...',
    'node.saved': 'Saved!',
    'node.saveError': 'Error — Retry',
    // Multiverse
  ...
  ko: {
    ...
    'btn.semantic': 'AI 검색',
    'btn.folders': '폴더별 보기',
    'btn.clusterView': '클러스터',
    'btn.allNodes': '전체 노드',
    'btn.allClusters': '클러스터 전체',
    'btn.stars': '별자리',
    'btn.clusters': '주제 묶음',
    'btn.types': '종류',
    'btn.timeline': '시간순',
    ...
    'ingest.recent': '최근 저장',
    'ingest.goto': '→ 노드로 이동',
    'ingest.notIndexed': '아직 인덱싱 전이에요. 아래 "인덱싱" 버튼을 눌러주세요.',
    'ingest.reindexing': '인덱싱 중... (시간이 걸릴 수 있어요)',
    'ingest.reindexDone': '인덱싱 완료!',
    'ingest.reindexFail': '인덱싱 실패',
    'ingest.reindexBtn': '새 노트 인덱싱 (그래프에 반영)',
    'ingest.reindexBtnActive': '인덱싱 중...',
    'intel.ask': '질문하기',
    ...
    'intel.health': '지식 건강도',
    'node.edit': '편집',
    'node.editCancel': '편집 취소',
    'node.delete': '삭제',
    'node.deleteConfirm': '이 노트를 삭제할까요? Obsidian vault에서도 삭제됩니다.',
    'node.save': '저장 (Obsidian에도 반영)',
    'node.saving': '저장 중...',
    'node.saved': '저장 완료!',
    'node.saveError': '오류 — 재시도',
